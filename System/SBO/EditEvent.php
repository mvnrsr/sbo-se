...
<div class="event">
		...
		<form action="../inc/insert.inc.php" method="post">
			...
			<td><label for="">Event ID  : </label><input type="text" name="id" value="<?php echo $evId;?>" readonly></td>
				...
				<tr>
			<td><label for="">Event Title  : </label><input type="text" name="title" value="<?php echo $title; ?>"></td>
				</tr>
				<tr>
			...
			<td><label for="">Description  : </label>
				...
				<tr>
			<td><label for="">Start        : </label><input type="text" name="start" value="<?php echo $dateSt; ?>"></td>
				</tr>
				<tr>
			<td><label for="">End          : </label><input type="text" name="end" value="<?php echo $dateEnd; ?>"></td>
				</tr>
				<table>
			...
			<br>
			<button class="add-event" type="submit" >Save Changes</button>
		</form>
		</center>
	</div>
